...
class Notification(Define):
    ...
    WCA_AUTHORIZATION_DUPLICATED = (Status.DANGER.value, 'WCA IDが他アカウントと重複しています。認証に失敗しました。')
    ...
    COMPETITION_REGISTER_EDIT = (Status.SUCCESS.value, _('申し込み内容を更新しました。承認されるまでお待ち下さい。'))
    ...
    REGISTRATION_CANCEL = (Status.SUCCESS.value, '申し込みがキャンセルされました。')