    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "competition_name_id",
                    models.CharField(default="", max_length=64, verbose_name="大会名ID"),
                ),
                (
                    "competition_name",
                    models.CharField(default="", max_length=64, verbose_name="大会名"),
                ),
                ...
                (
                    "gender",
                    models.SmallIntegerField(
                        choices=[(1, "男性"), (2, "女性")], default=0, verbose_name="性別"
                    ),
                ),
                ...
                (
                    "generation_rank",
                    models.IntegerField(default=0, verbose_name="世代ランク"),
                ),
                (
                    "prefecture_rank",
                    models.IntegerField(default=0, verbose_name="県ランク"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.IntegerField(
                        primary_key=True, serialize=False, verbose_name="大会ID"
                    ),
                ),
                (
                    "type",
                ...
                (
                    "open_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="開始日"
                    ),
                ),
                (
                    "close_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="終了日"
                    ),
                ),
                (
                    "registration_open_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="申し込み開始日時"
                    ),
                ),
                (
                    "registration_close_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="申し込み終了日時"
                    ),
                ),
                (
                    "judge_person_ids",
                    django_mysql.models.JSONField(default=dict, verbose_name="審判員ID"),
                ),
                (
                    "stripe_user_person_id",
                    models.IntegerField(default=0, verbose_name="Stripe使用者ID"),
                ),
                (
                    "event_ids",
                    django_mysql.models.JSONField(default=dict, verbose_name="イベントID"),
                ),
                (
                    "prefecture_id",
                    models.SmallIntegerField(
                ...
                (
                    "organizer_person_ids",
                    django_mysql.models.JSONField(
                        default=dict, verbose_name="主催者SCJID"
                    ),
                ),
                ("venue_name", models.CharField(max_length=256, verbose_name="開催地名")),
                (
                    "venue_address",
                    models.CharField(max_length=256, verbose_name="開催地住所"),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="承認前の競技者の一覧表示フラグ"),
                ),
                (
                    "fee_pay_type",
                    models.SmallIntegerField(
                        choices=[(1, "現地支払"), (2, "事前支払または現地支払"), (3, "事前支払")],
                        default=0,
                        verbose_name="参加費支払いタイプ",
                    ),
                ),
                (
                    "fee_calc_type",
                ...
                (
                    "is_cancel",
                    models.BooleanField(default=False, verbose_name="キャンセル可否"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.SmallIntegerField(
                        choices=[(1, "PENDING"), (2, "REGISTRATION"), (3, "CANCEL")],
                        verbose_name="状態",
                    ),
                ),
                (
                    "event_ids",
                    django_mysql.models.JSONField(
                        default=dict, verbose_name="申し込み種目ID"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.IntegerField(
                        choices=[(1, "WCA大会"), (2, "SCJ大会"), (3, "イベント"), (4, "お知らせ")],
                        verbose_name="種類",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name_roma",
                    models.CharField(max_length=64, verbose_name="名(ローマ字)"),
                ),
                (
                    "last_name_roma",
                    models.CharField(max_length=64, verbose_name="姓(ローマ字)"),
                ),
                (
                    "gender",
                    models.SmallIntegerField(
                ...
                (
                    "wca_user_id",
                    models.IntegerField(default=0, verbose_name="WCA_USER_ID"),
                ),
                (
                    "wca_email",
                    models.EmailField(
                        default="", max_length=254, verbose_name="WCA EMAIL"
                    ),
                ),
                (
                    "wca_name",
                    models.CharField(default="", max_length=256, verbose_name="WCA氏名"),
                ),
                (
                    "wca_country_iso2",
                    models.CharField(default="", max_length=2, verbose_name="WCA所属国"),
                ),
                (
                    "wca_access_token",
                    models.CharField(max_length=256, verbose_name="WCAアクセストークン"),
                ),
                (
                    "wca_refresh_token",
                    models.CharField(max_length=256, verbose_name="WCAリフレッシュトークン"),
                ),
                (
                    "wca_avatar_url",
                    models.CharField(max_length=256, verbose_name="アバター"),
                ),
                (
                    "wca_avatar_thumb_url",
                    models.CharField(max_length=256, verbose_name="アバターサムネイル"),
                ),
                (
                    "stripe_user_id",
                    models.CharField(
                        default="", max_length=256, verbose_name="STRIPE_USER_ID"
                    ),
                ),
                ("is_judge", models.BooleanField(default=False, verbose_name="審判員フラグ")),
                (
                    "is_community_posting_offer",
                    models.BooleanField(default=False, verbose_name="宣伝申請許可"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="作成日時"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.IntegerField(
                        primary_key=True, serialize=False, verbose_name="ラウンドID"
                    ),
                ),
                ("competition_id", models.IntegerField(verbose_name="大会ID")),
                (
                ...
                (
                    "event_name",
                    models.CharField(default="", max_length=64, verbose_name="イベント名"),
                ),
                (
                    "attempt_count",
                    models.SmallIntegerField(default=0, verbose_name="挑戦回数"),
                ),
                (
                    "type",
                    models.SmallIntegerField(
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="フォーマットID",
                    ),
                ),
                (
                    "limit_type",
                    models.SmallIntegerField(
                        choices=[(1, "時間制限"), (2, "累計時間制限")],
                        default=0,
                        verbose_name="制限タイプ",
                    ),
                ),
                ...
                (
                    "cutoff_attempt_count",
                    models.SmallIntegerField(default=0, verbose_name="カットオフ回数"),
                ),
                ("cutoff_time", models.IntegerField(verbose_name="カットオフ時間")),
                ("proceed_count", models.IntegerField(verbose_name="通過人数")),
                (
                    "room_name",
                    models.CharField(default="", max_length=64, verbose_name="会場名"),
                ),
                (
                    "begin_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="開始時刻"
                    ),
                ),
                (
                    "end_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="終了時刻"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "customer_id",
                    models.CharField(max_length=64, verbose_name="Stripe顧客ID"),
                ),
                ...
                (
                    "charge_id",
                    models.CharField(
                        default="", max_length=256, verbose_name="Stripe決済ID"
                    ),
                ),
                ...
                (
                    "pay_at",
                    models.DateTimeField(default=None, null=True, verbose_name="支払日時"),
                ),
                (
                    "refund_at",
                    models.DateTimeField(default=None, null=True, verbose_name="返金日時"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="作成日時"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["event_id", "wca_id"], name="idx_event_id_wca_id"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="competitor",
            index=models.Index(
                fields=["competition_id", "person"], name="idx_competition_id_person"
            ),
        ),
        migrations.AddIndex(
            model_name="bestrank",
