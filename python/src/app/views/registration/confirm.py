...
class Confirm(TemplateView):
    def get(self, request):
        ...
        context = {
            ...
            "gender": dict(person_form.fields["gender"].choices)[
                int(person_form.data["gender"])
            ],
            "prefecture": dict(person_form.fields["prefecture_id"].choices)[
                int(person_form.data["prefecture_id"])
            ],
